...
//        binding.spinnerViewSido.setOnSpinnerItemSelectedListener(object : OnSpinnerItemSelectedListener<String> {
...
//                newItem: String
//            ) {
//                Toast.makeText(this@MainActivity, "$newItem", Toast.LENGTH_SHORT).show()
//                Log.d("miseya", "seletedItem: spinnerViewSido selected >  $newItem")
