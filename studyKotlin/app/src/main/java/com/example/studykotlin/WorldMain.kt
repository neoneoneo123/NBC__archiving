...
fun selectWorld(selectWorld: Int, myCharacter: Characters) {
...
fun openCashShop(characters: Characters) {
    var cashShop = CashShop.getInstance()

    if(characters is Archer) {
        println("구매전 무기: ${characters.weapons}")
        cashShop.purchaseWeapon(characters)
        println("구매후 무기: ${characters.weapons}")
