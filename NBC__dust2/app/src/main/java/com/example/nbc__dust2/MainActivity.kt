package com.example.nbc__dust2

import com.example.nbc__dust2.data.DustItem
import com.example.nbc__dust2.databinding.ActivityMainBinding
import com.example.nbc__dust2.retrofit.NetWorkClient
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpDustParameter(sido: String): HashMap<String, String> {
        val authKey =
            "cpaEff+fBSNn0sePBS09fjpwKSP2XnJekX3fFbhMcL5FCB7ATlANCCM/VWa3k+Jw5N4NMgFSNhVIcITL7HA5+w=="
